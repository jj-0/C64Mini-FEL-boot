...
/*
#if PLAT_MEM_SIZE == SZ_256M
*/
#   define SUPER_STANDBY_BASE             (PLAT_PHYS_OFFSET + SZ_32M + SZ_16M + SZ_64K)
/*
#else
#   define SUPER_STANDBY_BASE             (0x52000000)
#endif
*/
...
#define HW_RESERVED_MEM_SIZE_256M      (0x04000000 + 0x02200000)   		/* 80M(DE+VE(CSI)+FB) */
#if 0
#define HW_RESERVED_MEM_SIZE_256M      (0x01000000 + 0x00000000)   		/* 16M - Just FB */
#endif
...
#define SW_GPU_MEM_SIZE_256M           0x04000000 /* SZ_64M */
...
/* CHRIS */
#define SW_FB_MEM_BASE                  HW_RESERVED_MEM_BASE
